...
export function MainSidebar() {
  ...
  return (
    <aside className="hidden md:flex w-80 h-screen sticky top-0 bg-[#1E293B] border-r border-white/5 flex-col py-10 px-8 transition-all duration-500 overflow-hidden relative">
