    ...
    <div className="max-w-6xl mx-auto space-y-10 animate-in fade-in slide-in-from-bottom-6 duration-700">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-4 space-y-4">
           ...
           <div className="mt-10 p-8 bg-red-500 rounded-[2.5rem] text-white shadow-xl shadow-red-500/20 relative overflow-hidden group">
              <div className="relative z-10">
                <h4 className="text-xs font-black uppercase tracking-widest mb-4 flex items-center gap-2">
                   <AlertTriangle size={16} /> Maintenance
                </h4>
                <p className="text-[11px] font-bold opacity-80 uppercase leading-relaxed mb-6">Certaines modifications peuvent entraîner une déconnexion immédiate de tous les utilisateurs actifs.</p>
                <button className="w-full bg-white text-red-500 font-black uppercase text-[10px] tracking-widest py-4 rounded-2xl shadow-lg active:scale-95 transition-all">Activer le mode maintenance</button>
              </div>
        ...
        <div className="lg:col-span-8 space-y-8">
              ...
              <div className="space-y-8">
                 <div className="flex items-center justify-between">
                    <div className="max-w-md">
                       ...
                       <p className="text-[11px] text-gray-400 font-medium leading-relaxed mt-1">L'application s'adaptera automatiquement à l'heure locale pour préserver la vision nocturne des personnels.</p>
                    </div>
                    <div className="flex gap-2 bg-gray-100 p-1.5 rounded-2xl">
                       <button className="px-6 py-2.5 bg-white shadow-sm rounded-xl text-[10px] font-black uppercase text-red-500">Auto</button>
                       <button className="px-6 py-2.5 text-[10px] font-black uppercase text-gray-400">On</button>
                       <button className="px-6 py-2.5 text-[10px] font-black uppercase text-gray-400">Off</button>
                    </div>
                 </div>
                 ...
                 <div className="pt-8 border-t border-gray-50 flex items-center justify-between">
                    <div>
                       ...
                       <p className="text-[11px] text-gray-400 font-medium leading-relaxed mt-1">Détermine la langue des fiches techniques et du dictionnaire.</p>
                    </div>
                    <select className="bg-gray-50 border-none rounded-2xl px-8 py-3.5 font-black uppercase text-[10px] tracking-widest outline-none shadow-inner">
           ...
           {/* Danger Zone */}
           <div className="p-10 bg-gray-50/50 border-2 border-dashed border-gray-100 rounded-[3rem]">
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                 <div>
                    ...
                    <p className="text-[11px] text-gray-400 font-medium mt-1">Réinitialise toutes les images et fichiers temporaires du serveur.</p>
                 </div>
                 <button className="px-8 py-4 border border-red-200 text-red-500 text-[10px] font-black uppercase tracking-widest rounded-2xl hover:bg-red-50 transition-all">Purger maintenant</button>
              </div>
              <div className="mt-8 pt-8 border-t border-gray-100 flex flex-col md:flex-row md:items-center justify-between gap-6">
                 <div>
                    ...
                    <p className="text-[11px] text-gray-400 font-medium mt-1">Efface l'intégralité de la base de données Supabase (Action irréversible).</p>
                 </div>
                 <button className="px-8 py-4 bg-red-600 text-white text-[10px] font-black uppercase tracking-widest rounded-2xl shadow-xl shadow-red-600/20 active:scale-95 transition-all">Détruire la base</button>
              </div>
           </div>
        </div>
      </div>
